...
export const progressApi = {
  ...
  getEnrollment: (courseId: string) =>
    api.get(`/api/progress/enrollment/${courseId}`),
  updateVideoProgress: (
    lessonId: string,
    data: { progress: number; total_duration: number },
  ...
  getAllProgress: (courseId: string) =>
    api.get(`/api/progress/course/${courseId}/all`),
};
...
export const certificatesApi = {
  ...
  verify: (certNumber: string) =>
    api.get(`/api/certificates/verify/${certNumber}`),
};
...
export const studentApi = {
  ...
  getTimeline: (params?: any) => api.get("/api/student/timeline", { params }),
...
export const recommendationsApi = {
  ...
  getSimilar: (courseId: string) =>
    api.get(`/api/recommendations/similar/${courseId}`),
};
